/*1. Визначити тип пряма на площині  за трьома дійсними числами. 
Крім необхідних методів (конструкторів, введення-виведення,...) визначити метод знаходження точки перетину двох прямих, 
метод знаходження кута перетину двох прямих, методи перевірки, чи належить точка заданій прямій, чи прямі паралельні. 
Ввести дані про 10 прямих. Визначити 1) для кожної прямої список прямих, що з нею перетинаються та координати точок перетину 
2) скільки з них паралельні осі ОХ і скільки з них перетинаються з нею під прямим кутом. */

/*1.  
методи перевірки, чи належить точка заданій прямій, 

Ввести дані про 10 прямих. Визначити 
1) для кожної прямої список прямих, що з нею перетинаються та координати точок перетину
2) скільки з них паралельні осі ОХ і скільки з них перетинаються з нею під прямим кутом. */
